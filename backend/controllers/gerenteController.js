...
exports.abrirCrudGerente = (req, res) => {
//  console.log('gerenteController - Rota /abrirCrudGerente - abrir o crudGerente');
  res.sendFile(path.join(__dirname, '../../frontend/gerente/gerente.html'));
} //
