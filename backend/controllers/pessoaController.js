...
exports.criarPessoa = async (req, res) => {
  ...
  try {
    ...
    const result = await query(
      'INSERT INTO pessoa (id_pessoa, nome_pessoa, email_pessoa, senha_pessoa, cpf_pessoa) VALUES ($1, $2, $3, $4, $5) RETURNING *',
      [id_pessoa, nome_pessoa, email_pessoa, senha_pessoa, cpf_pessoa]
    );
...
exports.atualizarPessoa = async (req, res) => {
  try {
    const id = parseInt(req.params.id);
    const { nome_pessoa, email_pessoa, senha_pessoa, cpf_pessoa} = req.body;
    ...
    const updatedFields = {
      ...
      cpf_pessoa: cpf_pessoa !== undefined ? cpf_pessoa : currentPerson.cpf_pessoa
    };

    // Atualiza a pessoa
    const updateResult = await query(
      'UPDATE pessoa SET nome_pessoa = $1, email_pessoa = $2, senha_pessoa = $3, cpf_pessoa = $4 WHERE id_pessoa = $5 RETURNING *',
      [updatedFields.nome_pessoa, updatedFields.email_pessoa, updatedFields.senha_pessoa, updatedFields.cpf_pessoa, id]
    );
...
exports.atualizarSenha = async (req, res) => {
  try {
    ...
    const updateResult = await query(
      'UPDATE pessoa SET senha_pessoa = $1 WHERE id_pessoa = $2 RETURNING id_pessoa, nome_pessoa, email_pessoa, cpf_pessoa',
      [nova_senha, id]
    );
